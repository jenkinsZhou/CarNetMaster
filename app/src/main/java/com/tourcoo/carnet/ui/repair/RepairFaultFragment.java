...
import com.tourcoo.carnet.core.frame.retrofit.ProgressRequestBody;
...
import com.tourcoo.carnet.core.frame.retrofit.UploadRequestBody;
 ...
 */
public class RepairFaultFragment extends BaseTitleFragment implements View.OnClickListener, EasyPermissions.PermissionCallbacks {
...
//                selectPhoto();
    ...
    private void getLocate() {
        ...
        if (checkLocatePermission()) {
            ...
            PermissionManager.requestPermission(RepairFaultFragment.this, PermissionConstance.TIP_PERMISSION_LOCATE, PermissionConstance.PERMISSION_CODE_LOCATE, PermissionConstance.PERMS_LOCATE);
        }
    }
...
//            sb.append("回调时间: " + Utils.formatUTC(System.currentTimeMillis(), "yyyy-MM-dd HH:mm:ss") + "\n");
    ...
    private void uploadReportFault(CarInfoEntity carInfoEntity) {
        ...
        ApiRepository.getInstance().reportFault(carInfoEntity, mImages, getDetail(), currentPosition, mapLocation.getAddress()).compose(bindUntilEvent(FragmentEvent.DESTROY)).
    ...
    private static class MyHandler extends Handler {
        WeakReference<RepairFaultFragment> mFaultFragmentWeakReference;

        MyHandler(RepairFaultFragment repairFaultFragment) {
